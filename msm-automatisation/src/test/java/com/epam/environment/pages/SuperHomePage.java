...
public class SuperHomePage extends Page {
	...
	protected static final MyElement airportFlyingFromField = new MyElement("airportFlyingFromField", "//input[@id='flyingFromField_input']", "text");
	protected static final MyElement airportFlyingToField = new MyElement("airportFlyingToField", "//input[@id='flyingToField_input']", "text");
	...
	protected static final MyElement directFlightsOnlyCheckbox = new MyElement("directFlightsOnlyCheckbox", "//input[@id='isDirectOnly']", "checkbox");
	...
	protected static final MyElement adultsSelector = new MyElement("adultsSelector", "//select[@id='flightsAdults']", "dropdown");
	protected static final MyElement childrenSelector = new MyElement("childrenSelector", "//select[@id='flightsChildren']", "dropdown");
	protected static final MyElement infantsSelector = new MyElement("infantsSelector", "//select[@id='flightsInfants']", "dropdown");
	...
	public void checkSuperHomePageContentSGF() throws InterruptedException {
		...
		FieldsShop.fillFieldByValue(departDatePicker, "20 June 2016", driver);
		Thread.sleep(3000);
	}
